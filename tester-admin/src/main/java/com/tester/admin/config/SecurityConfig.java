package com.tester.admin.config;

import com.tester.admin.security.filter.JwtAuthenticationTokenFilter;
import com.tester.admin.security.handle.AuthenticationEntryPointImpl;
import com.tester.admin.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig {
    ...
    @Configuration
    @Order(99)
    public static class TesterSecurityConfig extends WebSecurityConfigurerAdapter {
        /** 自定义用户认证逻辑 */
        ...
        @Bean
        @Primary
        public AuthenticationManager testerAuthenticationManagerBean() throws Exception {
